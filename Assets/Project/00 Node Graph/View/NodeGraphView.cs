...
namespace Glib.NovelGameEditor
{
    public class NodeGraphView : GraphView
    {
        ...
        public NodeGraphView()
        {
            ...
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Project/00 Node Graph/View/NodeGraphView.uss");
        ...
        private void CreateNodeView(Glib.NovelGameEditor.Node node)
        {
            ...
            {
                nodeView = new AnimationNodeView(animationNode);
            }
            ...
            if (branchNode != null)
            {
                nodeView = new BranchNodeView(this, branchNode);
